...
for i, url in ipairs(ui_urls) do
    ...
    if success and result then
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "🎨 HDANH HUB";
            Text = "Đang tải theme hồng GRADIENT...\n✨ Hồng nhạt → Hồng đậm\nVui lòng đợi 3 giây!";
            Duration = 4;
        })
        ...
        spawn(function()
                            ...
                            for _, obj in pairs(gui:GetDescendants()) do
                                ...
                                if obj:IsA("Frame") or obj:IsA("ScrollingFrame") then
                                    ...
                                    if c.R > 0.7 and c.G > 0.6 and c.B < 0.5 then
                                        ...
                                        if delay == 1 then print("✅ Đổi vàng -> hồng: " .. obj.Name) end
                                    end
                                end
            ...
            wait(1)
            game:GetService("StarterGui"):SetCore("SendNotification", {
                Title = "✅ HDANH HUB - PINK GRADIENT THEME";
                Text = "Theme hồng GRADIENT đã áp dụng!\n✨ Hồng nhạt → Hồng đậm tuyệt đẹp\n🎚️ Toggle: Trượt trái/phải\n💎 Chúc farm vui!";
                Duration = 6;
            })
        end)
...
if not ui_loaded then
    ...
    title.BackgroundColor3 = Color3.fromRGB(255, 105, 180)  -- Hồng đậm đẹp
    ...
    -- Thêm gradient cho title (Hồng nhạt -> Hồng đậm)
    ...
    titleGradient.Rotation = 90  -- Gradient từ trên xuống
    ...
    closeBtn.Text = "✖"
    closeBtn.BackgroundColor3 = Color3.fromRGB(220, 50, 100)  -- Hồng đỏ
    ...
    -- Thêm gradient cho close button (Đỏ hồng nhạt -> đậm)
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "✅ HDANH HUB";
    Text = "UI đã load thành công!\n💎 Đang áp dụng theme GRADIENT hồng nhạt-đậm...";
    Duration = 5;
})
                ...
                if gui:IsA("ScreenGui") and gui.Name ~= "ControlGUI" and gui.Name ~= "HDANHBackupUI" then
                    for _, obj in pairs(gui:GetDescendants()) do
                        ...
                        if obj:IsA("Frame") or obj:IsA("ScrollingFrame") then
                            ...
                            -- Phát hiện màu VÀNG (R>0.7, G>0.6, B<0.5)
                            if c.R > 0.7 and c.G > 0.6 and c.B < 0.5 then
...
spawn(function()
    ...
    pcall(function()
        ...
        local function CreateiOSToggle(originalButton)
            ...
            toggleContainer.BackgroundColor3 = Color3.fromRGB(70, 35, 60)  -- OFF: Hồng tối (sẽ có gradient)
            ...
            -- Thêm gradient cho toggle container (OFF state - Hồng nhạt -> Hồng đậm hơn)
            local toggleGradientOff = Instance.new("UIGradient")
            toggleGradientOff.Name = "GradientOff"
            toggleGradientOff.Color = ColorSequence.new{
            ...
            toggleGradientOff.Rotation = 45  -- Góc xiên đẹp
            toggleGradientOff.Parent = toggleContainer
            ...
            local function UpdateToggle(enabled, animate)
                ...
                if animate then
                    ...
                    if enabled then
                        -- ON: Gradient hồng sáng -> hồng đậm
                        toggleGradientOff.Color = ColorSequence.new{
            ...
            print("✅ Tạo iOS toggle cho: " .. originalButton.Name)
        end
