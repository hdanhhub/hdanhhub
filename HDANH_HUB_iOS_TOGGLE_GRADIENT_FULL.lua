                        ...
                        if gui:IsA("ScreenGui") and (gui.Name:find("Redz") or gui.Name:find("Library") or gui.Name:find("UI")) then
                            for _, obj in pairs(gui:GetDescendants()) do
                                ...
                                if obj:IsA("Frame") or obj:IsA("ScrollingFrame") then
                                    ...
                                    -- Nền vàng -> Hồng GRADIENT
                                    if c.R > 0.7 and c.G > 0.6 and c.B < 0.5 then
                                        obj.BackgroundColor3 = Color3.fromRGB(255, 105, 180)
                                        
                                        -- Thêm gradient nếu chưa có
                                        if not obj:FindFirstChild("PinkGradient") then
                                            ...
                                            gradient.Color = ColorSequence.new{
                                                ...
                                                ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 105, 180))   -- Hồng đậm (hot pink)
                                            }
                                            gradient.Rotation = 45  -- Góc xiên đẹp
                                            gradient.Parent = obj
                                        end
                                        
                                        if delay == 1 then print("✅ Đổi vàng -> hồng gradient: " .. obj.Name) end
                                    end
                                end
                                ...
                                if obj:IsA("TextButton") then
                                    ...
                                    -- Nút vàng -> Hồng ON với GRADIENT
                                    if c.R > 0.7 and c.G > 0.6 and c.B < 0.5 then
                                        obj.BackgroundColor3 = Color3.fromRGB(255, 105, 180)
                                        
                                        -- Thêm gradient cho button ON
                                        if not obj:FindFirstChild("ButtonGradient") then
                                            local gradient = Instance.new("UIGradient")
                                            gradient.Name = "ButtonGradient"
                                            gradient.Color = ColorSequence.new{
                                                ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 150, 200)),  -- Hồng nhạt
                                                ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 105, 180))   -- Hồng đậm
                                            }
                                    ...
                                    -- Nút xám/tối -> Hồng OFF với GRADIENT
                                    local brightness = (c.R + c.G + c.B) / 3
                                    if brightness > 0.3 and brightness < 0.6 then
                                        obj.BackgroundColor3 = Color3.fromRGB(80, 40, 70)
                                        
                                        -- Thêm gradient cho button OFF
                                        if not obj:FindFirstChild("ButtonGradientOff") then
                                            local gradient = Instance.new("UIGradient")
                                            gradient.Name = "ButtonGradientOff"
                                            gradient.Color = ColorSequence.new{
                                                ColorSequenceKeypoint.new(0, Color3.fromRGB(100, 50, 85)),  -- Hồng nhạt hơn
                                                ColorSequenceKeypoint.new(1, Color3.fromRGB(60, 30, 55))    -- Hồng đậm hơn
                                            }
                                            gradient.Rotation = 45
                                            gradient.Parent = obj
                                        end
                ...
                if gui:IsA("ScreenGui") and gui.Name ~= "ControlGUI" and gui.Name ~= "HDANHBackupUI" then
                    for _, obj in pairs(gui:GetDescendants()) do
                        ...
                        if obj:IsA("Frame") or obj:IsA("ScrollingFrame") then
                            ...
                            -- Phát hiện màu VÀNG (R>0.7, G>0.6, B<0.5) -> Thêm GRADIENT
                            if c.R > 0.7 and c.G > 0.6 and c.B < 0.5 then
                                obj.BackgroundColor3 = Color3.fromRGB(255, 105, 180)  -- HOT PINK
                                ...
                                if not obj:FindFirstChild("PinkGradient") then
                                    ...
                                    gradient.Color = ColorSequence.new{
                                        ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 150, 200)),  -- Hồng nhạt
                                        ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 105, 180))   -- Hot pink đậm
                                    }
                                    gradient.Rotation = 45
                                    gradient.Parent = obj
                                end
...
spawn(function()
    ...
    pcall(function()
        ...
        local function CreateiOSToggle(originalButton)
            ...
            toggleContainer.BackgroundColor3 = Color3.fromRGB(70, 35, 60)  -- OFF: Base color (gradient sẽ override)
            ...
            -- Thêm GRADIENT cho toggle container
            local toggleGradient = Instance.new("UIGradient")
            toggleGradient.Name = "ToggleGradient"
            -- Bắt đầu với gradient OFF (hồng tối)
            ...
            slider.Position = UDim2.new(0, 3, 0.5, 0)
            slider.AnchorPoint = Vector2.new(0, 0.5)
            slider.BackgroundColor3 = Color3.fromRGB(255, 255, 255)  -- Slider trắng
            ...
            local function UpdateToggle(enabled, animate)
                ...
                if animate then
                    -- Animation trượt
                    local targetPos = enabled and UDim2.new(1, -27, 0.5, 0) or UDim2.new(0, 3, 0.5, 0)
                    
                    -- Thay đổi GRADIENT khi bật/tắt
                    if enabled then
                        -- ON: Gradient hồng sáng -> hồng đậm rực rỡ
                        toggleGradient.Color = ColorSequence.new{
                            ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 150, 200)),  -- Hồng nhạt sáng
                            ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 105, 180))   -- Hot pink đậm
                        }
                    else
                        -- OFF: Gradient hồng tối nhạt -> đậm
                        toggleGradient.Color = ColorSequence.new{
                            ColorSequenceKeypoint.new(0, Color3.fromRGB(100, 50, 85)),  -- Hồng nhạt hơn
                            ColorSequenceKeypoint.new(1, Color3.fromRGB(60, 30, 55))    -- Hồng đậm hơn
                        }
                    ...
                    -- Không animation
                    slider.Position = enabled and UDim2.new(1, -27, 0.5, 0) or UDim2.new(0, 3, 0.5, 0)
                    ...
                    if enabled then
                        ...
                        toggleGradient.Color = ColorSequence.new{
                            ...
                            ColorSequenceKeypoint.new(1, Color3.fromRGB(60, 30, 55))
                        }
                    end
                end
            end
