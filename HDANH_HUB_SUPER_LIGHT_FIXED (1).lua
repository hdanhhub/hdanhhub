...
-- CUSTOM SQUARE TOGGLE - Hình vuông trong suốt viền hồng đậm
spawn(function()
    ...
    pcall(function()
        ...
        -- Function tạo Square toggle switch
        local function CreateSquareToggle(originalButton)
            ...
            -- Tạo container cho toggle - HÌNH VUÔNG
            local toggleBox = Instance.new("Frame")
            toggleBox.Name = "SquareToggle_" .. originalButton.Name
            toggleBox.Size = UDim2.new(0, 28, 0, 28)  -- Hình vuông 28x28
            toggleBox.Position = UDim2.new(1, -35, 0.5, -14)  -- Bên phải
            toggleBox.AnchorPoint = Vector2.new(0, 0.5)
            toggleBox.BackgroundColor3 = Color3.fromRGB(255, 255, 255)  -- Nền trắng trong suốt
            toggleBox.BackgroundTransparency = 1  -- TRONG SUỐT hoàn toàn
            toggleBox.BorderSizePixel = 0
            toggleBox.Parent = parent
            
            -- Bo góc nhẹ cho vuông (không tròn hoàn toàn)
            local boxCorner = Instance.new("UICorner")
            boxCorner.CornerRadius = UDim.new(0, 4)  -- Bo góc nhẹ
            boxCorner.Parent = toggleBox
            
            -- Thêm VIỀN HỒNG ĐẬM
            local boxStroke = Instance.new("UIStroke")
            boxStroke.Color = Color3.fromRGB(255, 105, 180)  -- HỒNG ĐẬM (Hot Pink)
            boxStroke.Thickness = 3  -- Viền dày
            ...
            local function UpdateToggle(enabled, animate)
                ...
                if animate then
                    ...
                    if enabled then
                        -- BẬT: Tô FULL ô vuông bằng HỒNG NHẠT
                        local tweenBg = TweenService:Create(toggleBox, tweenInfo, {
                            BackgroundTransparency = 0,  -- Không trong suốt nữa
                            BackgroundColor3 = Color3.fromRGB(255, 182, 193)  -- HỒNG NHẠT (Light Pink)
                        })
                        tweenBg:Play()
                    else
                        -- TẮT: Trở lại TRONG SUỐT
                        local tweenBg = TweenService:Create(toggleBox, tweenInfo, {
                            BackgroundTransparency = 1,  -- Trong suốt hoàn toàn
                            BackgroundColor3 = Color3.fromRGB(255, 255, 255)  -- Trắng
                        })
                        tweenBg:Play()
                    end
                else
                    -- Không animation - set trực tiếp
                    if enabled then
                        toggleBox.BackgroundTransparency = 0
                        toggleBox.BackgroundColor3 = Color3.fromRGB(255, 182, 193)  -- HỒNG NHẠT
                    else
                        toggleBox.BackgroundTransparency = 1
                        toggleBox.BackgroundColor3 = Color3.fromRGB(255, 255, 255)  -- Trắng
                    end
                end
            end
            ...
            -- Hover effect - Làm viền sáng hơn khi hover
            toggleBox.MouseEnter:Connect(function()
                boxStroke.Color = Color3.fromRGB(255, 20, 147)  -- Deep Pink khi hover
                boxStroke.Thickness = 4  -- Dày hơn
            end)
            toggleBox.MouseLeave:Connect(function()
                boxStroke.Color = Color3.fromRGB(255, 105, 180)  -- Trở lại Hot Pink
                boxStroke.Thickness = 3
            end)
            
            -- Set initial state (TẮT = trong suốt)
            UpdateToggle(false, false)
            
            print("✅ Tạo Square toggle cho: " .. originalButton.Name)
        end
