...
for i, url in ipairs(ui_urls) do
    ...
    if success and result then
        ...
        -- Notification
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "🎨 HDANH HUB - GRADIENT";
            Text = "Đang tải theme GRADIENT hồng...\n✨ Hồng nhạt → Hồng đậm\nVui lòng đợi 3 giây!";
            Duration = 4;
        })
        ...
        spawn(function()
                        ...
                        if gui:IsA("ScreenGui") and (gui.Name:find("Redz") or gui.Name:find("Library") or gui.Name:find("UI")) then
                            for _, obj in pairs(gui:GetDescendants()) do
                                ...
                                if obj:IsA("Frame") or obj:IsA("ScrollingFrame") then
                                    ...
                                    -- Nền vàng -> Hồng GRADIENT NHẠT
                                    if c.R > 0.7 and c.G > 0.6 and c.B < 0.5 then
                                        obj.BackgroundColor3 = Color3.fromRGB(255, 140, 190)  -- Base NHẠT hơn
                                        
                                        -- Thêm gradient nếu chưa có - NHẠT HƠN
                                        if not obj:FindFirstChild("PinkGradient") then
                                            local gradient = Instance.new("UIGradient")
                                            gradient.Name = "PinkGradient"
                                            gradient.Color = ColorSequence.new{
                                                ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 180, 210)),  -- Hồng NHẠT
                                                ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 140, 190))   -- Hồng vừa
                                            }
                                            gradient.Rotation = 45  -- Góc xiên đẹp
                                            gradient.Parent = obj
                                        end
                                        
                                        if delay == 1 then print("✅ Đổi vàng -> hồng gradient NHẠT: " .. obj.Name) end
                                    end
                                end
                                
                                -- AGGRESSIVE - Đổi NÚT với GRADIENT
                                if obj:IsA("TextButton") then
                                    local c = obj.BackgroundColor3
                                    
                                    -- Nút vàng -> Hồng ON với GRADIENT NHẠT
                                    if c.R > 0.7 and c.G > 0.6 and c.B < 0.5 then
                                        obj.BackgroundColor3 = Color3.fromRGB(255, 140, 190)  -- Base nhạt hơn
                                        
                                        -- Thêm gradient cho button ON - NHẠT HƠN
                                    ...
                                    -- Nút xám/tối -> Hồng OFF với GRADIENT RẤT NHẠT
                                    local brightness = (c.R + c.G + c.B) / 3
                                    if brightness > 0.3 and brightness < 0.6 then
                                        obj.BackgroundColor3 = Color3.fromRGB(120, 70, 100)  -- Base NHẠT HƠN
                                        
                                        -- Thêm gradient cho button OFF - RẤT NHẠT
                                        if not obj:FindFirstChild("ButtonGradientOff") then
                                            local gradient = Instance.new("UIGradient")
                                            gradient.Name = "ButtonGradientOff"
                                            gradient.Color = ColorSequence.new{
                                                ColorSequenceKeypoint.new(0, Color3.fromRGB(150, 100, 130)),  -- Hồng NHẠT
                                                ColorSequenceKeypoint.new(1, Color3.fromRGB(100, 60, 85))     -- Hồng vừa
                                            }
                                            gradient.Rotation = 45
                                            gradient.Parent = obj
                                        end
            ...
            wait(1)
            game:GetService("StarterGui"):SetCore("SendNotification", {
                Title = "✅ HDANH HUB - PINK GRADIENT";
                Text = "Theme GRADIENT hồng hoàn tất!\n✨ Hồng nhạt → Hồng đậm\n🎚️ Toggle: Trượt trái/phải\n💎 Chúc farm vui!";
                Duration = 6;
            })
        end)
...
if not ui_loaded then
    ...
    title.BackgroundColor3 = Color3.fromRGB(255, 105, 180)  -- Hồng đậm base
    ...
    -- THÊM GRADIENT cho title
    local titleGradient = Instance.new("UIGradient")
    titleGradient.Color = ColorSequence.new{
        ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 150, 200)),  -- Hồng nhạt
        ColorSequenceKeypoint.new(1, Color3.fromRGB(220, 80, 150))    -- Hồng đậm
    }
    ...
    closeBtn.Text = "✖"
    closeBtn.BackgroundColor3 = Color3.fromRGB(220, 50, 100)  -- Hồng đỏ base
    ...
    -- THÊM GRADIENT cho close button
    local closeBtnGradient = Instance.new("UIGradient")
    closeBtnGradient.Color = ColorSequence.new{
        ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 100, 140)),  -- Hồng đỏ nhạt
        ColorSequenceKeypoint.new(1, Color3.fromRGB(200, 40, 90))     -- Hồng đỏ đậm
    }
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "✅ HDANH HUB";
    Text = "UI đã load thành công!\n💎 Đang áp dụng GRADIENT hồng nhạt-đậm...";
    Duration = 5;
})
                ...
                if gui:IsA("ScreenGui") and gui.Name ~= "ControlGUI" and gui.Name ~= "HDANHBackupUI" then
                    for _, obj in pairs(gui:GetDescendants()) do
                        ...
                        if obj:IsA("Frame") or obj:IsA("ScrollingFrame") then
                            ...
                            -- Phát hiện màu VÀNG (R>0.7, G>0.6, B<0.5) -> Thêm GRADIENT NHẠT
                            if c.R > 0.7 and c.G > 0.6 and c.B < 0.5 then
                                obj.BackgroundColor3 = Color3.fromRGB(255, 140, 190)  -- Base NHẠT hơn
...
spawn(function()
    ...
    pcall(function()
        ...
        local function CreateiOSToggle(originalButton)
            ...
            toggleContainer.BackgroundColor3 = Color3.fromRGB(50, 25, 45)  -- OFF: Base color NHẠT hơn
            ...
            -- Thêm GRADIENT cho toggle container - MÀU NHẠT HỠN
            local toggleGradient = Instance.new("UIGradient")
            toggleGradient.Name = "ToggleGradient"
            -- Bắt đầu với gradient OFF (hồng RẤT NHẠT)
            toggleGradient.Color = ColorSequence.new{
                ColorSequenceKeypoint.new(0, Color3.fromRGB(150, 100, 130)),  -- Hồng NHẠT (tăng từ 100->150)
                ColorSequenceKeypoint.new(1, Color3.fromRGB(90, 50, 75))      -- Hồng vừa (tăng từ 60->90)
            }
            toggleGradient.Rotation = 45  -- Góc xiên đẹp
            toggleGradient.Parent = toggleContainer
            
            -- Tạo slider (nút tròn) - TO HỞN VÀ ĐẬM HƠN
            local slider = Instance.new("Frame")
            slider.Name = "Slider"
            slider.Size = UDim2.new(0, 26, 0, 26)  -- Tăng từ 24->26 để nổi bật hơn
            slider.Position = UDim2.new(0, 2, 0.5, 0)  -- Giảm từ 3->2 để căn giữa
            slider.AnchorPoint = Vector2.new(0, 0.5)
            slider.BackgroundColor3 = Color3.fromRGB(255, 255, 255)  -- Slider trắng tinh
            slider.BorderSizePixel = 0
            slider.Parent = toggleContainer
            
            -- Thêm bóng cho slider để nổi bật
            local sliderShadow = Instance.new("UIStroke")
            sliderShadow.Color = Color3.fromRGB(200, 200, 200)
            sliderShadow.Thickness = 1
            sliderShadow.Transparency = 0.5
            ...
            -- Function cập nhật toggle
            local function UpdateToggle(enabled, animate)
                isEnabled = enabled
                
                if animate then
                    -- Animation trượt
                    local targetPos = enabled and UDim2.new(1, -28, 0.5, 0) or UDim2.new(0, 2, 0.5, 0)  -- Điều chỉnh vị trí cho slider 26px
                    
                    -- Thay đổi GRADIENT khi bật/tắt - MÀU NHẠT HƠN
                    if enabled then
                        -- ON: Gradient hồng SÁNG NHẠT -> hồng vừa
                        toggleGradient.Color = ColorSequence.new{
                            ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 180, 210)),  -- Hồng NHẠT SÁNG (tăng từ 150->180)
                            ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 140, 190))   -- Hồng vừa (tăng từ 105->140)
                        }
                    else
                        -- OFF: Gradient hồng RẤT NHẠT
                        toggleGradient.Color = ColorSequence.new{
                            ColorSequenceKeypoint.new(0, Color3.fromRGB(150, 100, 130)),  -- Hồng NHẠT
                            ColorSequenceKeypoint.new(1, Color3.fromRGB(90, 50, 75))      -- Hồng vừa
                        }
                    end
                    ...
                    if enabled then
                        -- ON: Gradient hồng SÁNG NHẠT
                        toggleGradient.Color = ColorSequence.new{
                            ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 180, 210)),
                            ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 140, 190))
                        }
                    else
                        -- OFF: Gradient hồng RẤT NHẠT
                        toggleGradient.Color = ColorSequence.new{
                            ColorSequenceKeypoint.new(0, Color3.fromRGB(150, 100, 130)),
                            ColorSequenceKeypoint.new(1, Color3.fromRGB(90, 50, 75))
                        }
                    end
                end
            end
            ...
            print("✅ Tạo iOS toggle GRADIENT cho: " .. originalButton.Name)
        end
